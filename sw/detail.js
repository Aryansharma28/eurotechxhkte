...
function ElderDetail({ id, lang, onClose, onVisit, onReload }) {
  ...
  const neuroAlert = typeof BIOMARKERS !== "undefined" ? (_a = BIOMARKERS[e.id]) == null ? void 0 : _a.alertLevel : null;
  return /* @__PURE__ */ React.createElement("div", { className: "drawer-scrim scrim", onClick: onClose }, /* @__PURE__ */ React.createElement("div", { className: "drawer", onClick: (ev) => ev.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "dh" }, /* @__PURE__ */ React.createElement("div", { className: "dh-top" }, /* @__PURE__ */ React.createElement("button", { className: "iconbtn", onClick: onClose }, I.x), /* @__PURE__ */ React.createElement(Pill, { kind: r.cls }, L(lang, r.en, r.zh))), /* @__PURE__ */ React.createElement("div", { className: "dh-id" }, /* @__PURE__ */ React.createElement(Avatar, { name: e.name_zh, size: 62 }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { className: "dnm" }, L(lang, e.name_en, e.name_zh), " ", /* @__PURE__ */ React.createElement("span", { className: "dzh" }, L(lang, e.name_zh, e.name_en))), /* @__PURE__ */ React.createElement("div", { className: "dmeta" }, e.age, L(lang, " yrs", " \u6B72"), " \xB7 ", L(lang, e.sex === "F" ? "Female" : "Male", e.sex === "F" ? "\u5973" : "\u7537"), " \xB7 ", L(lang, `Discharged ${(_b = e.day_since_discharge) != null ? _b : "?"} days ago`, `\u51FA\u9662\u7B2C ${(_c = e.day_since_discharge) != null ? _c : "?"} \u5929`), " \xB7 ", L(lang, e.lives_en, e.lives_zh)))), /* @__PURE__ */ React.createElement("div", { className: "dh-actions" }, /* @__PURE__ */ React.createElement("button", { className: "btn primary", onClick: () => onVisit(e.id) }, I.map, L(lang, "Start home visit", "\u958B\u59CB\u5BB6\u8A2A")), /* @__PURE__ */ React.createElement("button", { className: "btn ghost", onClick: async (ev) => {
    const btn = ev.currentTarget;
    btn.disabled = true;
    try {
      await API.post("/api/simulate-call", { elder_id: e.id });
      onReload && onReload();
    } catch (err2) {
      alert("Simulate failed: " + err2.message);
    } finally {
      btn.disabled = false;
    }
  } }, I.phone, L(lang, "Simulate call", "\u6A21\u64EC\u901A\u8A71")), /* @__PURE__ */ React.createElement("button", { className: "btn ghost" }, I.note, L(lang, "Add note", "\u65B0\u589E\u8A18\u9304")))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", borderBottom: "1px solid var(--line)", padding: "0 20px", flexShrink: 0 } }, [
    { k: "overview", en: "Overview", zh: "\u6982\u89BD" },
    { k: "neuro", en: "Neuro", zh: "\u795E\u7D93", badge: neuroAlert }
  ].map((t) => /* @__PURE__ */ React.createElement("button", { key: t.k, onClick: () => setTab(t.k), style: {
    background: "none",
    border: "none",
    cursor: "pointer",
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "dcard card" }, /* @__PURE__ */ React.createElement("h3", { style: { display: "flex", alignItems: "center", gap: 8 } }, I.wave, " ", L(lang, "Voice biomarkers", "\u8A9E\u97F3\u751F\u7269\u6A19\u8A8C"), liveFields.size > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "var(--stable)", fontWeight: 600, background: "var(--stable-bg)", borderRadius: 6, padding: "2px 7px" } }, "LIVE")), bm.alertLevel && /* @__PURE__ */ React.createElement("div", { className: "riskbanner " + bm.alertLevel, style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { className: "aic", style: { color: bm.alertLevel === "risk" ? "var(--risk-ink)" : "var(--watch-ink)" } }, I.alert), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "rt" }, bm.alertLevel === "risk" ? L(lang, "Notable voice change \u2014 consider review", "\u8A9E\u97F3\u51FA\u73FE\u986F\u8457\u8B8A\u5316 \u2014 \u8003\u616E\u8907\u8A3A") : L(lang, "Voice pattern shift \u2014 monitor closely", "\u8A9E\u97F3\u6A21\u5F0F\u6709\u8F15\u5FAE\u504F\u79FB \u2014 \u5BC6\u5207\u8DDF\u9032")))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, marginBottom: 14 } }, ["parkinson", "neuroDec"].map((k) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: k, style: { flex: 1, display: "flex", flexDirection: "column", gap: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--ink-faint)", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" } }, L(lang, t.label_en, t.label_zh), isLive && /* @__PURE__ */ React.createElement("span", { style: { marginLeft: 3, fontSize: 8, color: "var(--stable)", fontWeight: 900 } }, "\u25CF")), /* @__PURE__ */ React.createElement(DrawerSparkline, { values, level, width: 120, height: 40 }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 22, fontWeight: 800, fontFamily: "var(--mono)", color: numColor, lineHeight: 1 } }, today), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "var(--ink-faint)" } }, t.unit), level !== "ok" && /* @__PURE__ */ React.createElement("span", { className: "pill " + level, style: { fontSize: 9, padding: "1px 7px" } }, /* @__PURE__ */ React.createElement("span", { className: "dot" }), level)));
    })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, paddingTop: 10, borderTop: "0.5px solid var(--line)", flexWrap: "wrap" } }, ["rate", "pauses", "pitch", "tremor", "fluency"].map((k) => {
      const t = thresholds[k];
      if (!t) return null;
      ...
      const isLive = liveFields.has(k);
      const numColor = level === "risk" ? "var(--risk-ink)" : level === "watch" ? "var(--watch-ink)" : "var(--ink)";
      return /* @__PURE__ */ React.createElement("div", { key: k, style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 2, minWidth: 50 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9, color: "var(--ink-faint)", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.04em", textAlign: "center", whiteSpace: "nowrap" } }, L(lang, t.label_en, t.label_zh), isLive && /* @__PURE__ */ React.createElement("span", { style: { marginLeft: 2, fontSize: 7, color: "var(--stable)", fontWeight: 900 } }, "\u25CF")), /* @__PURE__ */ React.createElement(DrawerSparkline, { values, level, width: 52, height: 22 }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, fontWeight: 700, fontFamily: "var(--mono)", color: numColor, lineHeight: 1 } }, k === "pauses" ? today.toFixed(2) : String(today), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 8, fontWeight: 400, color: "var(--ink-faint)", marginLeft: 1 } }, t.unit)), level !== "ok" && /* @__PURE__ */ React.createElement("span", { className: "pill " + level, style: { fontSize: 8, padding: "1px 5px" } }, /* @__PURE__ */ React.createElement("span", { className: "dot" }), level));
